...
!function (e, t) {
    ...
    return function (e) {
        ...
        n = [i(4), i(5), i(6), i(7), i(8), i(3)], o = function (e, t, i, n, o, s) {
            ...
            return r.set = function (e, t) {
                ...
                var t = this, i = this.content, n = s.getAbsoluteTop(i), o = i.clientHeight, r = n + o, a = 24, l = 50;
                ...
                return{dom: l, scrollTop: this.content ? this.content.scrollTop : 0, range: s.getSelectionOffset()}
                ...
                if (t.hasChildNodes()) {
                    for (var o = t.childNodes, s = "", r = 0, a = o.length; a > r; r++) {
                        ...
                        if ("DIV" == l.nodeName || "P" == l.nodeName) {
                            var c = o[r - 1], h = c ? c.nodeName : void 0;
        ...
        n = [i(9), i(10), i(3)], o = function (e, t, i) {
            ...
            n.prototype._updateEditability = function () {
                ...
                var t, s, r, a, l, c, h, d, u, g, f, p, m, v, A = e.pageY, C = e.pageX, w = !1;
                if (t = this.dom.tr, u = i.getAbsoluteTop(t), p = t.offsetHeight, u > A) {
                    s = t;
                    do s = s.previousSibling, h = n.getNodeFromTarget(s), g = s ? i.getAbsoluteTop(s) : 0; while (s && g > A);
                    ...
                    do d = n.getNodeFromTarget(r), r && (m = r.nextSibling ? i.getAbsoluteTop(r.nextSibling) : 0, v = r ? m - f : 0, 1 == d.parent.childs.length && d.parent.childs[0] == this && (u += 23)), r = r.nextSibling; while (r && A > u + v);
                    if (d && d.parent) {
                        var E = C - this.drag.mouseX, F = Math.round(E / 24 / 2), b = this.drag.level + F, y = d.getLevel();
                        for (s = d.dom.tr.previousSibling; b > y && s;) {
                            if (h = n.getNodeFromTarget(s), h == this || h._isChildOf(this)); else {
                ...
                var t, s, r, a, l = e.which || e.keyCode, c = e.target || e.srcElement, h = e.ctrlKey, d = e.shiftKey, u = e.altKey, g = !1, f = "tree" === this.editor.options.mode;
                if (13 == l) {
                    if (c == this.dom.value)(!this.editable.value || e.ctrlKey) && i.isUrl(this.value) && (window.open(this.value, "_blank"), g = !0); else if (c == this.dom.expand) {
                ...
                } else if (68 == l)h && f && (this._onDuplicate(), g = !0); else if (69 == l)h && (this._onExpand(d), c.focus(), g = !0); else if (77 == l && f)h && (this.showContextMenu(c), g = !0); else if (46 == l && f)h && (this._onRemove(), g = !0); else if (45 == l && f)h && !d ? (this._onInsertBefore(), g = !0) : h && d && (this._onInsertAfter(), g = !0); else if (35 == l) {
                    if (u) {
                ...
                } else if (38 == l)u && !d ? (t = this._previousNode(), t && t.focus(n.focusElement || this._getElementName(c)), g = !0) : u && d && (t = this._previousNode(), t && t.parent && (t.parent.moveBefore(this, t), this.focus(n.focusElement || this._getElementName(c))), g = !0); else if (39 == l) {
                    if (u && !d) {
                ...
                } else if (40 == l)if (u && !d)s = this._nextNode(), s && s.focus(n.focusElement || this._getElementName(c)), g = !0; else if (u && d && f) {
                ...
                if (this.parent && this.parent._hasChilds()) {
                    ...
                    o == l[l.length - 1] && r.push({text: "Append", title: "Append a new field with type 'auto' after this field (Ctrl+Shift+Ins)", submenuTitle: "Select the type of the field to be appended", className: "append", click: function () {
                        o._onAppend("", "", "auto")
                    }, submenu: [
        ...
        n = [i(3)], o = function (e) {
            ...
            return t.prototype._getVisibleButtons = function () {
                ...
                this.hide();
                var n = window.innerHeight, o = window.pageYOffset || document.scrollTop || 0, s = n + o, r = i.offsetHeight, a = this.maxHeight, l = e.getAbsoluteLeft(i), c = e.getAbsoluteTop(i);
                ...
                var i, n, o, s, r = t.target, a = t.which, l = !1;
    ...
    var i = e("./lib/dom"), n = e("./lib/event"), o = e("./editor").Editor, s = e("./edit_session").EditSession, r = e("./undomanager").UndoManager, a = e("./virtual_renderer").VirtualRenderer;
    e("./worker/worker_client"), e("./keyboard/hash_handler"), e("./placeholder"), e("./multi_select"), e("./mode/folding/fold_mode"), e("./theme/textmate"), e("./ext/error_marker"), t.config = e("./config"), t.require = e, t.edit = function (e) {
        ...
        var l = new o(new a(e));
        l.setSession(r);
        var c = {document: r, editor: l, onResize: l.resize.bind(l, null)};
        ...
        this.normalizeRules = function () {
            function i(s) {
                ...
                for (var a = 0; a < r.length; a++) {
                    ...
                    if (l.include || "string" == typeof l)var u = l.include || l, g = o[u]; else Array.isArray(l) && (g = l);
                    if (g) {
                        var f = [a, 1].concat(g);
    ...
    (function () {
        i.implement(this, n), this.getPosition = function () {
            ...
            if ((i.start.row != i.end.row || i.start.row == this.row) && !(i.start.row > this.row || i.start.row == this.row && i.start.column > this.column)) {
                var n = this.row, o = this.column, s = i.start, r = i.end;
    ...
    function i() {
        this.getFoldAt = function (e, t, i) {
            ...
            for (var o, s, r = {end: {column: 0}}, a = 0; a < n.folds.length; a++) {
                s = n.folds[a];
            ...
            for (var i = this.$foldData, n = t - e + 1, o = 0; o < i.length; o++) {
                var s = i[o], r = s.end.row, a = s.start.row;
                if (r >= t) {
                    t > a && (a >= e ? n -= t - a : n = 0);
                    break
                }
            ...
            if (c > a || a == c && h - 2 >= l) {
                ...
                return r || (p = this.$addFoldLine(new o(this.$foldData, i))), this.$useWrapMode ? this.$updateWrapData(p.start.row, p.start.row) : this.$updateRowLengthCache(p.start.row, p.start.row), this.$modified = !0, this._emit("changeFold", {data: i, action: "add"}), i
            }
            ...
            var i, o;
            if (null == e ? (i = new n(0, 0, this.getLength(), 0), t = !0) : i = "number" == typeof e ? new n(e, 0, e, this.getLine(e).length) : "row"in e ? n.fromPoints(e, e) : e, o = this.getFoldsInRangeList(i), t)this.removeFolds(o); else for (var s = o; s.length;)this.expandFolds(s), s = this.getFoldsInRangeList(i);
            ...
            if (o.isEmpty()) {
                ...
                (i = this.findMatchingBracket(s)) ? 1 == o.comparePoint(i) ? o.end = i : (o.start = i, o.start.column++, o.end.column--) : (i = this.findMatchingBracket({row: s.row, column: s.column + 1})) ? (1 == o.comparePoint(i) ? o.end = i : o.start = i, o.start.column++) : o = this.getCommentFoldRange(s.row, s.column) || o
            } else {
            ...
            var o = new r(this, e, t), s = o.getCurrentToken();
            if (s && /^comment|string/.test(s.type)) {
                var a = new n, l = new RegExp(s.type.replace(/\..*/, "\\."));
                if (1 != i) {
                    do s = o.stepBackward(); while (s && l.test(s.type));
                    o.stepForward()
                }
                if (a.start.row = o.getCurrentTokenRow(), a.start.column = o.getCurrentTokenColumn() + 2, o = new r(this, e, t), -1 != i) {
                    do s = o.stepForward(); while (s && l.test(s.type));
                    s = o.stepBackward()
            ...
            return{range: -1 !== o && r, firstRange: n}
            ...
            if (this.getFoldWidget) {
                var i = this.getFoldWidget(e), n = this.getLine(e), o = "end" === i ? -1 : 1, s = this.getFoldAt(e, -1 === o ? 0 : n.length, o);
    ...
    var n = e("../range").Range, o = e("./fold_line").FoldLine, s = e("./fold").Fold, r = e("../token_iterator").TokenIterator;
    t.Folding = i
    ...
    (function () {
        this.shiftRow = function (e) {
            ...
            var n, o, s, r = 0, a = this.folds, l = !0;
            ...
            if (s)if (n = s.fold, "inside" == s.kind && n.start.column != t && n.start.row != e)window.console && window.console.log(e, t, n); else if (n.start.row == e) {
                o = this.folds;
                var r = o.indexOf(n);
            ...
            var n = this.getNextFoldTo(e, t).fold, o = this.folds, s = this.foldData;
            if (!n)return null;
            var r = o.indexOf(n), a = o[r - 1];
            ...
            for (var t, i = 0, n = 0; n < this.folds.length; n++) {
                var t = this.folds[n];
                if (e -= t.start.column - i, 0 > e)return{row: t.start.row, column: t.start.column + e};
    ...
    var i = 1e3, n = function (e) {
        ...
        for (var t in this.states) {
            for (var i = this.states[t], n = [], o = 0, s = this.matchMappings[t] = {defaultToken: "text"}, r = "g", a = [], l = 0; l < i.length; l++) {
                var c = i[l];
    ...
    (function () {
        this.$setMaxTokenCount = function (e) {
            ...
            for (var n = [], o = 0, s = i.length; s > o; o++)t[o] && (n[n.length] = {type: i[o], value: t[o]});
            return n
        }, this.$arrayTokens = function (e) {
            if (!e)return[];
            var t = this.splitRegex.exec(e);
            if (!t)return"text";
            for (var i = [], n = this.tokenArray, o = 0, s = n.length; s > o; o++)t[o + 1] && (i[i.length] = {type: n[o], value: t[o + 1]});
            return i
            ...
            var o = t || "start", s = this.states[o];
            s || (o = "start", s = this.states[o]);
            var r = this.matchMappings[o], a = this.regExps[o];
            a.lastIndex = 0;
            for (var l, c = [], h = 0, d = {type: null, value: ""}; l = a.exec(e);) {
                var u = r.defaultToken, g = null, f = l[0], p = a.lastIndex;
                if (p - f.length > h) {
                    var m = e.substring(h, p - f.length);
                    d.type == u ? d.value += m : (d.type && c.push(d), d = {type: u, value: m})
                }
                ...
                if (f)if ("string" == typeof u)g && g.merge === !1 || d.type !== u ? (d.type && c.push(d), d = {type: u, value: f}) : d.value += f; else if (u) {
                    d.type && c.push(d), d = {type: null, value: ""};
                    for (var v = 0; v < u.length; v++)c.push(u[v])
                }
                if (h == e.length)break;
                if (h = p, c.length > i) {
                    for (; h < e.length;)d.type && c.push(d), d = {value: e.substring(h, h += 2e3), type: "overflow"};
                    o = "start", n = [];
                    break
                }
            }
            return d.type && c.push(d), n.length > 1 && n[0] !== o && n.unshift(o), {tokens: c, state: n.length ? n : o}
        }
    ...
    var r = (e("../range").Range, e("../range_list").RangeList), a = e("../lib/oop"), l = t.Fold = function (e, t) {
    ...
    var i = e("../tokenizer").Tokenizer, n = e("./text_highlight_rules").TextHighlightRules, o = e("./behaviour").Behaviour, s = e("../unicode"), r = e("../lib/lang"), a = e("../token_iterator").TokenIterator, l = e("../range").Range, c = function () {
    ...
    (function () {
        this.tokenRe = new RegExp("^[" + s.packages.L + s.packages.Mn + s.packages.Mc + s.packages.Nd + s.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + s.packages.L + s.packages.Mn + s.packages.Mc + s.packages.Nd + s.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function () {
            ...
            var s = t.doc, a = !0, l = !0, c = 1 / 0, h = t.getTabSize(), d = !1;
            if (this.lineCommentStart) {
                if (Array.isArray(this.lineCommentStart))var u = this.lineCommentStart.map(r.escapeRegExp).join("|"), g = this.lineCommentStart[0]; else var u = r.escapeRegExp(this.lineCommentStart), g = this.lineCommentStart;
                ...
                var f = function (e, t) {
                    ...
                    (!a || /\S/.test(e)) && (A(e, c, c) ? s.insertInLine({row: t, column: c}, p) : s.insertInLine({row: t, column: c}, g))
                }, v = function (e) {
                    return u.test(e)
                }, A = function (e, t, i) {
                ...
                var g = this.blockComment.start, C = this.blockComment.end, u = new RegExp("^(\\s*)(?:" + r.escapeRegExp(g) + ")"), w = new RegExp("(?:" + r.escapeRegExp(C) + ")\\s*$"), m = function (e, t) {
                    v(e, t) || (!a || /\S/.test(e)) && (s.insertInLine({row: t, column: e.length}, C), s.insertInLine({row: t, column: c}, g))
                }, f = function (e, t) {
                    var i;
            ...
            if (o) {
                !o.start && o[0] && (o = o[0]);
                var s, r, c = new a(t, n.row, n.column), h = c.getCurrentToken(), d = (t.selection, t.selection.toOrientedRange());
                if (h && /comment/.test(h.type)) {
                    for (var u, g; h && /comment/.test(h.type);) {
                        var f = h.value.indexOf(o.start);
                        if (-1 != f) {
                            var p = c.getCurrentTokenRow(), m = c.getCurrentTokenColumn() + f;
            ...
            if (!this.completionKeywords) {
                ...
                for (var n in t)for (var o = t[n], s = 0, r = o.length; r > s; s++)if ("string" == typeof o[s].token)/keyword|support|storage/.test(o[s].token) && i.push(o[s].regex); else if ("object" == typeof o[s].token)for (var a = 0, l = o[s].token.length; l > a; a++)if (/keyword|support|storage/.test(o[s].token[a])) {
    ...
    (function () {
        this.isEqual = function (e) {
            ...
            if (this.start.row > t)var o = {row: t + 1, column: 0}; else if (this.start.row < e)var o = {row: e, column: 0};
            return n.fromPoints(o || this.start, i || this.end)
        }, this.extend = function (e, t) {
            var i = this.compare(e, t);
            if (0 == i)return this;
            if (-1 == i)var o = {row: e, column: t}; else var s = {row: e, column: t};
    ...
    function i() {
        this.findMatchingBracket = function (e, t) {
            ...
            var o = this.$brackets[e], s = 1, r = new n(this, t.row, t.column), a = r.getCurrentToken();
            if (a || (a = r.stepForward()), a) {
                ...
                for (var l = t.column - r.getCurrentTokenColumn() - 2, c = a.value; ;) {
                    for (; l >= 0;) {
                        var h = c.charAt(l);
                        if (h == o) {
                            if (s -= 1, 0 == s)return{row: r.getCurrentTokenRow(), column: l + r.getCurrentTokenColumn()}
                        } else h == e && (s += 1);
                        l -= 1
                    }
    ...
    var i = e("./lib/oop"), n = e("./lib/lang"), o = e("./lib/event_emitter").EventEmitter, s = e("./range").Range, r = function (e) {
    ...
    (function () {
        i.implement(this, o), this.isEmpty = function () {
            ...
            var e = this.lead.row, t = this.lead.column, i = this.session.documentToScreenRow(e, t), n = this.session.screenToDocumentPosition(i, 0), o = this.session.getDisplayLine(e, null, n.row, n.column), s = o.match(/^\s*/);
            ...
            var t, i, n = 0, o = /\s/, s = this.session.tokenRe;
            if (s.lastIndex = 0, t = this.session.tokenRe.exec(e))n = this.session.tokenRe.lastIndex; else {
                for (; (i = e[n]) && o.test(i);)n++;
                if (1 > n)for (s.lastIndex = 0; (i = e[n]) && !s.test(i);)if (s.lastIndex = 0, n++, o.test(i)) {
                    if (n > 2) {
                        n--;
                        break
                    }
            ...
            if (t == i.length) {
                ...
                do e++, n = this.doc.getLine(e); while (s > e && /^\s*$/.test(n));
                /^\s+/.test(n) || (n = ""), t = 0
            }
            ...
            var s = n.stringReverse(o), r = this.$shortWordEndIndex(s);
    ...
    var i = e("./lib/lang"), n = e("./lib/oop"), o = e("./range").Range, s = function () {
        this.$options = {}
    };
    (function () {
        this.set = function (e) {
            ...
            if (t.$isMultiLine) {
                ...
                e:for (var d = a.offset || 0; h >= d; d++) {
                    ...
                    var g = s[d], f = s[d + c - 1], p = g.length - g.match(a[0])[0].length, m = f.match(a[c - 1])[0].length;
            ...
            if (!n)return!1;
            var s, r = this, a = t.backwards;
            if (t.$isMultiLine)var l = n.length, c = function (t, i, r) {
                var a = t.search(n[0]);
                if (-1 != a) {
            ...
            var i = 1 == t.backwards, n = 0 != t.skipCurrent, o = t.range, s = t.start;
            s || (s = o ? o[i ? "end" : "start"] : e.selection.getRange()), s.start && (s = s[n != i ? "end" : "start"]);
            var r = o ? o.start.row : 0, a = o ? o.end.row : e.getLength() - 1, l = i ? function (i) {
                var n = s.row, o = e.getLine(n).substring(0, s.column);
                if (!i(o, n)) {
                    for (n--; n >= r; n--)if (i(e.getLine(n), n))return;
                    if (0 != t.wrap)for (n = a, r = s.row; n >= r; n--)if (i(e.getLine(n), n))return
                }
            } : function (i) {
                var n = s.row, o = e.getLine(n).substr(s.column);
                if (!i(o, n, s.column)) {
    ...
    var i = e("./lib/oop"), n = e("./lib/lang"), o = e("./config"), s = e("./lib/event_emitter").EventEmitter, r = e("./selection").Selection, a = e("./mode/text").Mode, l = e("./range").Range, c = e("./document").Document, h = e("./background_tokenizer").BackgroundTokenizer, d = e("./search_highlight").SearchHighlight, u = function (e, t) {
    ...
    (function () {
        ...
        i.implement(this, s), this.setDocument = function (e) {
            ...
            !this.$fromUndo && this.$undoManager && !t.ignore && (this.$deltasDoc.push(t), i && 0 != i.length && this.$deltasFold.push({action: "removeFolds", folds: i}), this.$informUndoManager.schedule()), this.bgTokenizer.$updateOnChange(t), this._signal("change", e)
            ...
            if (null == t)s = n.length - 1, o = this.getLine(e).length; else for (var s = 0; s < n.length && (o += n[s].value.length, !(o >= t)); s++);
            ...
            var o = this.$markerId++, s = {range: e, type: i || "line", renderer: "function" == typeof i ? i : null, clazz: t, inFront: !!n, id: o};
            ...
            var s = t;
            if (s > 0) {
                do s--; while (s >= 0 && i.charAt(s).match(o));
                s++
            }
            ...
            var n = this.getTextRange(e), o = this.getFoldsInRange(e), s = l.fromPoints(t, t);
            if (!i) {
                this.remove(e);
            ...
            if (s.end = this.insert(s.start, n), o.length) {
                var c = e.start, h = s.start, r = h.row - c.row, a = h.column - c.column;
            ...
            var s = new l(e, 0, t, Number.MAX_VALUE), r = this.getFoldsInRange(s).map(function (e) {
            ...
            var t, i = this.$useWrapMode, n = e.data.action, o = e.data.range.start.row, s = e.data.range.end.row, r = e.data.range.start, a = e.data.range.end, l = null;
            ...
            var i, n, o = this.doc.getAllLines(), s = this.getTabSize(), r = this.$wrapData, a = this.$wrapLimit, l = e;
        ...
        var r = 1, c = 2, u = 3, g = 4, f = 9, p = 10, m = 11, v = 12;
        this.$computeWrapSplits = function (e, t) {
            function i(t) {
                var i = e.slice(s, t), o = i.length;
            ...
            for (var n = [], o = e.length, s = 0, r = 0, a = this.$wrapAsCode; o - s > t;) {
                var l = s + t;
                if (e[l - 1] >= p && e[l] >= p)i(l); else if (e[l] != u && e[l] != g) {
            ...
            var i, n, o = 0, s = 0, r = 0, a = 0, l = this.$screenRowCache, c = this.$getRowCacheIndex(l, e), h = l.length;
            if (h && c >= 0)var r = l[c], o = this.$docRowCache[c], d = e > l[h - 1]; else var d = !h;
            ...
            if (g && g.start.row <= o)i = this.getFoldDisplayLine(g), o = g.start.row; else {
                if (e >= r + a || o > u)return{row: u, column: this.getLine(u).length};
            ...
            return s += this.$getStringScreenWidth(i, t)[1], this.$useWrapMode && s >= n && (s = n - 1), g ? g.idxToPosition(s) : {row: o, column: s}
    ...
    var i = e("../lib/oop"), n = e("../keyboard/hash_handler").HashHandler, o = e("../lib/event_emitter").EventEmitter, s = function (e, t) {
    ...
    (function () {
        this.addCommand = function (e) {
            ...
            if (e) {
                if ("function" == typeof t)return void this.addCommand({exec: t, bindKey: e, name: t.name || e});
                var i = this.commandKeyBinding;
            ...
            if (n.FUNCTION_KEYS[o])i = n.FUNCTION_KEYS[o].toLowerCase(); else {
    ...
    function i(e) {
        e.on("click", function (t) {
            ...
            var i = e.renderer.$gutterLayer.getRegion(t);
            if ("foldWidgets" == i) {
                var n = t.getDocumentPosition().row, o = e.session, s = o.getParentFoldRangeData(n, !0), r = s.range || s.firstRange;
                if (r) {
                    n = r.start.row;
                    var a = o.getFoldAt(n, o.getLine(n).length, 1);
                    a ? o.removeFold(a) : (o.addFold("...", r), e.renderer.scrollCursorIntoView({row: r.start.row, column: 0}))
                }
                t.stop()
            }
        })
    ...
    var n = e("../lib/lang"), o = e("../config"), s = e("../range").Range;
    t.commands = [
        ...
        {name: "goToNextError", bindKey: i("Alt-E", "Ctrl-E"), exec: function (e) {
            o.loadModule("ace/ext/error_marker", function (t) {
                t.showErrorMarker(e, 1)
            })
        }, scrollIntoView: "animate", readOnly: !0},
        {name: "goToPreviousError", bindKey: i("Alt-Shift-E", "Ctrl-Shift-E"), exec: function (e) {
            o.loadModule("ace/ext/error_marker", function (t) {
                t.showErrorMarker(e, -1)
            })
        }, scrollIntoView: "animate", readOnly: !0},
        ...
        {name: "unfold", bindKey: i("Alt-Shift-L|Ctrl-Shift-F1", "Command-Alt-Shift-L|Command-Shift-F1"), exec: function (e) {
        ...
        {name: "foldall", bindKey: i("Ctrl-Alt-0", "Ctrl-Command-Option-0"), exec: function (e) {
            e.session.foldAll()
        }, scrollIntoView: "center", readOnly: !0},
        ...
        {name: "selecttostart", bindKey: i("Ctrl-Shift-Home", "Command-Shift-Up"), exec: function (e) {
        ...
        {name: "selectup", bindKey: i("Shift-Up", "Shift-Up"), exec: function (e) {
        ...
        {name: "selecttoend", bindKey: i("Ctrl-Shift-End", "Command-Shift-Down"), exec: function (e) {
            e.getSelection().selectFileEnd()
        }, multiSelectAction: "forEach", readOnly: !0, scrollIntoView: "animate", aceCommandGroup: "fileJump"},
        {name: "gotoend", bindKey: i("Ctrl-End", "Command-End|Command-Down"), exec: function (e) {
            e.navigateFileEnd()
        }, multiSelectAction: "forEach", readOnly: !0, scrollIntoView: "animate", aceCommandGroup: "fileJump"},
        {name: "selectdown", bindKey: i("Shift-Down", "Shift-Down"), exec: function (e) {
        ...
        {name: "selecttolinestart", bindKey: i("Alt-Shift-Left", "Command-Shift-Left"), exec: function (e) {
            e.getSelection().selectLineStart()
        }, multiSelectAction: "forEach", scrollIntoView: "cursor", readOnly: !0},
        {name: "gotolinestart", bindKey: i("Alt-Left|Home", "Command-Left|Home|Ctrl-A"), exec: function (e) {
            e.navigateLineStart()
        }, multiSelectAction: "forEach", scrollIntoView: "cursor", readOnly: !0},
        {name: "selectleft", bindKey: i("Shift-Left", "Shift-Left"), exec: function (e) {
        ...
        {name: "selecttolineend", bindKey: i("Alt-Shift-Right", "Command-Shift-Right"), exec: function (e) {
        ...
        {name: "jumptomatching", bindKey: i("Ctrl-P", "Ctrl-Shift-P"), exec: function (e) {
            e.jumpToMatching()
        }, multiSelectAction: "forEach", readOnly: !0},
        {name: "selecttomatching", bindKey: i("Ctrl-Shift-P", null), exec: function (e) {
            e.jumpToMatching(!0)
        }, multiSelectAction: "forEach", readOnly: !0},
        ...
        {name: "backspace", bindKey: i("Shift-Backspace|Backspace", "Ctrl-Backspace|Shift-Backspace|Backspace|Ctrl-H"), exec: function (e) {
            e.remove("left")
        }, multiSelectAction: "forEach", scrollIntoView: "cursor"},
    ...
    i._emit = i._dispatchEvent = function (e, t) {
        ...
        var i = this._eventRegistry[e] || [], s = this._defaultHandlers[e];
        if (i.length || s) {
    ...
    (function () {
        this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, i.implement(this, f), this.updateCharacterSize = function () {
            ...
            var o = 0, s = this.$size, r = {width: s.width, height: s.height, scrollerHeight: s.scrollerHeight, scrollerWidth: s.scrollerWidth};
            ...
            var e = this.session, t = this.$size, i = t.height <= 2 * this.lineHeight, n = this.session.getScreenLength(), o = n * this.lineHeight, s = this.scrollTop % this.lineHeight, r = t.scrollerHeight + this.lineHeight, a = this.$getLongestLine(), l = !i && (this.$hScrollBarAlwaysVisible || t.scrollerWidth - a - 2 * this.$padding < 0), c = this.$horizScroll !== l;
            ...
            var h = !i && (this.$vScrollBarAlwaysVisible || t.scrollerHeight - o < 0), d = this.$vScroll !== h;
            ...
            var u, g, f = Math.ceil(r / this.lineHeight) - 1, p = Math.max(0, Math.round((this.scrollTop - s) / this.lineHeight)), m = p + f, v = this.lineHeight;
            ...
            var C = 0;
            return this.layerConfig.width != a && (C = this.CHANGE_H_SCROLL), (c || d) && (C = this.$updateCachedSize(!0, this.gutterWidth, t.width, t.height), this._signal("scrollbarVisibilityChanged"), d && (a = this.$getLongestLine())), this.layerConfig = {width: a, padding: this.$padding, firstRow: p, firstRowScreen: u, lastRow: m, lineHeight: v, characterWidth: this.characterWidth, minHeight: r, maxHeight: o, offset: s, gutterOffset: Math.max(0, Math.ceil((s + t.height - t.scrollerHeight) / v)), height: this.$size.scrollerHeight}, C
            ...
            if (0 !== this.$size.scrollerHeight) {
                var n = this.$cursorLayer.getPixelPosition(e), o = n.left, s = n.top, r = i && i.top || 0, a = i && i.bottom || 0, l = this.$scrollAnimation ? this.session.getScrollTop() : this.scrollTop;
            ...
            if (this.$animatedScroll) {
                ...
                if (e != i) {
                    ...
                    this.$scrollAnimation = {from: e, to: i, steps: s}, clearInterval(this.$timer), n.session.setScrollTop(s.shift()), n.session.$scrollTop = i, this.$timer = setInterval(function () {
            ...
            var i = this.scroller.getBoundingClientRect(), n = (e + this.scrollLeft - i.left - this.$padding) / this.characterWidth, o = Math.floor((t + this.scrollTop - i.top) / this.lineHeight), s = Math.round(n);
            return{row: o, column: s, side: n - s > 0 ? 1 : -1}
            ...
            var i = this.scroller.getBoundingClientRect(), n = this.session.documentToScreenPosition(e, t), o = this.$padding + Math.round(n.column * this.characterWidth), s = n.row * this.lineHeight;
            return{pageX: i.left + o - this.scrollLeft, pageY: i.top + s - this.scrollTop}
            ...
            function i(i) {
                ...
                if (i.cssClass) {
                    ...
                    s.$padding && o != s.$padding && s.setPadding(o), s.$theme = i.cssClass, s.theme = i, n.addCssClass(s.container, i.cssClass), n.setCssClass(s.container, "ace_dark", i.isDark), s.$size && (s.$size.width = 0, s.$updateSizeAsync()), s._dispatchEvent("themeLoaded", {theme: i}), t && t()
                }
            }

            var s = this;
            if (this.$themeId = e, s._dispatchEvent("themeChange", {theme: e}), e && "string" != typeof e)i(e); else {
    ...
    }).call(m.prototype), o.defineOptions(m.prototype, "renderer", {animatedScroll: {initialValue: !1}, showInvisibles: {set: function (e) {
    ...
    function n(n) {
        ...
        for (var s = {}, r = "", a = document.getElementsByTagName("script"), l = 0; l < a.length; l++) {
            var d = a[l], u = d.src || d.getAttribute("src");
            if (u) {
    ...
    var s = e("./lib/lang"), r = e("./lib/oop"), a = e("./lib/net"), l = e("./lib/event_emitter").EventEmitter, c = function () {
        return this
    ...
    var i = e("../lib/dom"), n = e("../lib/oop"), o = e("../lib/lang"), s = e("../lib/event_emitter").EventEmitter, r = function (e) {
    ...
    (function () {
        n.implement(this, s), this.setSession = function (e) {
            ...
            if (this.$annotations.length) {
                var t = e.data, i = t.range, n = i.start.row, o = i.end.row - n;
                if (0 !== o)if ("removeText" == t.action || "removeLines" == t.action)this.$annotations.splice(n, o + 1, null); else {
                    var s = new Array(o + 1);
            ...
            for (var t = this.session, n = e.firstRow, o = Math.min(e.lastRow + e.gutterOffset, t.getLength() - 1), s = t.getNextFoldLine(n), r = s ? s.start.row : 1 / 0, a = this.$showFoldWidgets && t.foldWidgets, l = t.$breakpoints, c = t.$decorations, h = t.$firstLineNumber, d = 0, u = t.gutterRenderer || this.$renderer, g = null, f = -1, p = n; ;) {
                ...
                g = this.$cells[++f], g || (g = {element: null, textNode: null, foldWidget: null}, g.element = i.createElement("div"), g.textNode = document.createTextNode(""), g.element.appendChild(g.textNode), this.element.appendChild(g.element), this.$cells[f] = g);
            ...
            var w = u ? u.getWidth(t, d, e) : d.toString().length * e.characterWidth, E = this.$padding || this.$computePadding();
    ...
    function i(e) {
        function t(e, t) {
            var i = Date.now(), o = !t || e.row != t.row, s = !t || e.column != t.column;
            if (!D || o || s)m.$blockScrolling += 1, m.moveCursorToPosition(e), m.$blockScrolling -= 1, D = i, k = {x: w, y: E}; else {
                var r = n(k.x, k.y, w, E);
        ...
        function i(e, t) {
            var i = Date.now(), n = m.renderer.layerConfig.lineHeight, o = m.renderer.layerConfig.characterWidth, s = m.renderer.scroller.getBoundingClientRect(), r = {x: {left: w - s.left, right: s.right - w}, y: {top: E - s.top, bottom: s.bottom - E}}, l = Math.min(r.x.left, r.x.right), c = Math.min(r.y.top, r.y.bottom), h = {row: e.row, column: e.column};
            2 >= l / o && (h.column += r.x.left < r.x.right ? -3 : 2), 1 >= c / n && (h.row += r.y.top < r.y.bottom ? -1 : 1);
            var d = e.row != h.row, u = e.column != h.column, g = !t || e.row != t.row;
        ...
        function p(e) {
            var t = ["copy", "copymove", "all", "uninitialized"], i = ["move", "copymove", "linkmove", "all", "uninitialized"], n = r.isMac ? e.altKey : e.ctrlKey, o = "uninitialized";
            try {
        ...
        var C, w, E, F, b, y, x, S, B, D, k, $ = m.container, _ = 0;
        this.onDragStart = function (e) {
            ...
            if (C) {
                ...
                if (S)switch (x) {
                    case"move":
                        b = b.contains(y.row, y.column) ? {start: y, end: y} : m.moveText(b, y);
                        break;
                    case"copy":
                        b = m.moveText(b, y, !0)
                } else {
                    var i = t.getData("Text");
                    b = {start: y, end: m.session.insert(y, i)}, m.focus(), x = null
                }
    ...
    var o = e("../lib/dom"), s = e("../lib/event"), r = e("../lib/useragent"), a = 200, l = 200, c = 5;
    (function () {
    ...
    (function () {
        this.$padding = 0, this.setPadding = function (e) {
                ...
                for (var i in this.markers) {
                    ...
                    if (o.range) {
                        ...
                        if (!s.isEmpty())if (s = s.toScreenRange(this.session), o.renderer) {
                            var r = this.$getTop(s.start.row, e), a = this.$padding + s.start.column * e.characterWidth;
            ...
            var s = this.$padding, r = n.lineHeight, a = this.$getTop(t.start.row, n), l = s + t.start.column * n.characterWidth;
            ...
            var r = n.lineHeight, a = (t.end.column + (o || 0) - t.start.column) * n.characterWidth, l = this.$getTop(t.start.row, n), c = this.$padding + t.start.column * n.characterWidth;
            e.push("<div class='", i, "' style='", "height:", r, "px;", "width:", a, "px;", "top:", l, "px;", "left:", c, "px;", s || "", "'></div>")
        }, this.drawFullLineMarker = function (e, t, i, n, o) {
            var s = this.$getTop(t.start.row, n), r = n.lineHeight;
    ...
    var i = e("../lib/oop"), n = e("../lib/dom"), o = e("../lib/lang"), s = (e("../lib/useragent"), e("../lib/event_emitter").EventEmitter), r = function (e) {
        ...
        i.implement(this, s), this.EOF_CHAR = "¶", this.EOL_CHAR_LF = "¬", this.EOL_CHAR_CRLF = "¤", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "→", this.SPACE_CHAR = "·", this.$padding = 0, this.$updateEolChar = function () {
            ...
            if (this.displayIndentGuides) {
                ...
                if (this.showInvisibles) {
                    ...
                    var a = o.stringRepeat(this.SPACE_CHAR, this.tabSize), l = this.TAB_CHAR + o.stringRepeat(" ", this.tabSize - 1)
            ...
            for (var o = this.element.ownerDocument.createDocumentFragment(), s = t, r = this.session.getNextFoldLine(s), a = r ? r.start.row : 1 / 0; s > a && (s = r.end.row + 1, r = this.session.getNextFoldLine(s, r), a = r ? r.start.row : 1 / 0), !(s > i);) {
                ...
                if (this.$renderLine(c, s, !1, s == a ? r : !1), l.innerHTML = c.join(""), this.$useLineGroups())l.className = "ace_line_group", o.appendChild(l), l.style.height = e.lineHeight * this.session.getRowLength(s) + "px"; else for (; l.firstChild;)o.appendChild(l.firstChild);
                s++
            }
            return o
        }, this.update = function (e) {
            ...
            var s = this, r = /\t|&|<|( +)|([\x00-\x1f\x80-\xa0\u1680\u180E\u2000-\u200f\u2028\u2029\u202F\u205F\u3000\uFEFF])|[\u1100-\u115F\u11A3-\u11A7\u11FA-\u11FF\u2329-\u232A\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFB\u3000-\u303E\u3041-\u3096\u3099-\u30FF\u3105-\u312D\u3131-\u318E\u3190-\u31BA\u31C0-\u31E3\u31F0-\u321E\u3220-\u3247\u3250-\u32FE\u3300-\u4DBF\u4E00-\uA48C\uA490-\uA4C6\uA960-\uA97C\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFAFF\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE66\uFE68-\uFE6B\uFF01-\uFF60\uFFE0-\uFFE6]/g, a = function (e, i, n, r) {
                ...
                if ("　" == e) {
                    var l = s.showInvisibles ? "ace_cjk ace_invisible ace_invisible_space" : "ace_cjk", c = s.showInvisibles ? s.SPACE_CHAR : "";
            ...
            for (var o = 0, s = 0, r = i[0], a = 0, l = 0; l < t.length; l++) {
                ...
                if (o + h.length < r)a = this.$renderToken(e, a, c, h), o += h.length; else {
            ...
            function i(e, t, i) {
                ...
                if (s != t) {
                    ...
                    r.length > i - t && (r = r.substring(0, i - t)), o.push({type: e[n].type, value: r}), s = t + r.length, n += 1
                }
                for (; i > s && n < e.length;) {
                    var r = e[n].value;
                    o.push(r.length + s > i ? {type: e[n].type, value: r.substring(0, i - s)} : e[n]), s += r.length, n += 1
                }
            }

            var n = this.session, o = [], s = n.getTokens(e);
            return t.walk(function (e, t, r, a, l) {
                null != e ? o.push({type: "fold", value: e}) : (l && (s = n.getTokens(t)), s.length && i(s, a, r))
    ...
    var i, n = e("../lib/dom"), o = function (e) {
    ...
    function i(e) {
        function t() {
            var t = d.getDocumentPosition().row, n = l.$annotations[t];
            if (!n)return i();
            ...
            if (u != n)if (u = n.text.join("<br/>"), c.setHtml(u), c.show(), a.on("mousewheel", i), e.$tooltipFollowsMouse)s(d); else {
                var g = l.$cells[a.session.documentToScreenRow(t, 0)].element, f = g.getBoundingClientRect(), p = c.getElement().style;
        ...
        var a = e.editor, l = a.renderer.$gutterLayer, c = new n(a.container);
    ...
    var o = e("../lib/dom"), s = e("../lib/oop"), r = e("../lib/event"), a = e("../tooltip").Tooltip;
    s.inherits(n, a), function () {
        this.setPosition = function (e, t) {
            var i = window.innerWidth || document.documentElement.clientWidth, n = window.innerHeight || document.documentElement.clientHeight, o = this.getWidth(), s = this.getHeight();
    ...
    var i = e("./lib/oop"), n = e("./lib/dom"), o = e("./lib/event"), s = e("./lib/event_emitter").EventEmitter, r = function (e) {
    ...
    (function () {
        this.onMouseDown = function (e) {
            ...
            if (0 !== o) {
                var s = n.getSelectionRange(), r = s.isEmpty();
            ...
            var t = this.editor, i = this.mousedownEvent.getShiftKey();
    ...
    var i = e("../lib/event"), n = e("../lib/useragent"), o = e("./default_handlers").DefaultHandlers, s = e("./default_gutter_handler").GutterHandler, r = e("./mouse_event").MouseEvent, a = e("./dragdrop_handler").DragdropHandler, l = e("../config"), c = function (e) {
    ...
    }).call(c.prototype), l.defineOptions(c.prototype, "mouseHandler", {scrollSpeed: {initialValue: 2}, dragDelay: {initialValue: 150}, dragEnabled: {initialValue: !0}, focusTimout: {initialValue: 0}, tooltipFollowsMouse: {initialValue: !0}}), t.MouseHandler = c
    ...
    var i = e("../lib/oop"), n = e("../lib/dom"), o = e("../lib/lang"), s = e("../lib/useragent"), r = e("../lib/event_emitter").EventEmitter, a = 0, l = t.FontMetrics = function (e) {
    ...
    (function () {
        i.implement(this, r), this.$characterSize = {width: 0, height: 0}, this.$testFractionalRect = function () {
            ...
            if (1 === a)var e = this.$measureNode.getBoundingClientRect(), t = {height: e.height, width: e.width}; else var t = {height: this.$measureNode.clientHeight, width: this.$measureNode.clientWidth / a};
    ...
    var i = e("../lib/event"), n = e("../lib/useragent"), o = e("../lib/dom"), s = e("../lib/lang"), r = n.isChrome < 18, a = n.isIE, l = function (e, t) {
        function l(e) {
            if (!p) {
                if (D)t = 0, i = e ? 0 : d.value.length - 1; else var t = e ? 2 : 1, i = 2;
                try {
        ...
        var k = !1, $ = function (e) {
            D && (e = D(e), D = null), f ? (l(), e && t.onPaste(e), f = !1) : e == u.charAt(0) ? k ? t.execCommand("del", {source: "ace"}) : t.execCommand("backspace", {source: "ace"}) : (e.substring(0, 2) == u ? e = e.substr(2) : e.charAt(0) == u.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == u.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == u.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)), k && (k = !1)
        }, _ = function () {
            if (!p) {
                var e = d.value;
                $(e), c()
        ...
        if (i.addListener(d, "compositionstart", I), n.isGecko ? i.addListener(d, "text", function () {
            ...
            k = !0, m || (m = d.style.cssText), d.style.cssText = "z-index:100000;" + (n.isIE ? "opacity:0.1;" : ""), l(t.selection.isEmpty()), t._emit("nativecontextmenu", {target: t, domEvent: e});
            var s = t.container.getBoundingClientRect(), r = o.computedStyle(t.container), a = s.top + (parseInt(r.borderTopWidth) || 0), c = s.left + (parseInt(s.borderLeftWidth) || 0), u = s.bottom - a - d.clientHeight, g = function (e) {
    ...
    var i = e("../lib/oop"), n = e("../lib/net"), o = e("../lib/event_emitter").EventEmitter, s = e("../config"), r = function (t, i, n, o) {
        if (this.$sendDeltaQueue = this.$sendDeltaQueue.bind(this), this.changeListener = this.changeListener.bind(this), this.onMessage = this.onMessage.bind(this), e.nameToUrl && !e.toUrl && (e.toUrl = e.nameToUrl), s.get("packaged") || !e.toUrl)o = o || s.moduleUrl(i, "worker"); else {
        ...
        try {
            ...
            var c = this.$workerBlob(o), h = window.URL || window.webkitURL, d = h.createObjectURL(c);
    ...
    var a = function (e, t, i) {
        ...
        var n = null, r = !1, a = Object.create(o), l = this;
    ...
    e("./lib/fixoldbrowsers");
    var i = e("./lib/oop"), n = e("./lib/dom"), o = e("./lib/lang"), s = e("./lib/useragent"), r = e("./keyboard/textinput").TextInput, a = e("./mouse/mouse_handler").MouseHandler, l = e("./mouse/fold_handler").FoldHandler, c = e("./keyboard/keybinding").KeyBinding, h = e("./edit_session").EditSession, d = e("./search").Search, u = e("./range").Range, g = e("./lib/event_emitter").EventEmitter, f = e("./commands/command_manager").CommandManager, p = e("./commands/default_commands").commands, m = e("./config"), v = function (e, t) {
    ...
    (function () {
        i.implement(this, g), this.$initOperationListeners = function () {
            ...
            if (this.$mergeUndoDeltas) {
                var t = this.prevOp, i = ["backspace", "del", "insertstring"], n = t.command && e.command.name == t.command.name;
            ...
            if (this.session.$bracketHighlight && (this.session.removeMarker(this.session.$bracketHighlight), this.session.$bracketHighlight = null), !this.$highlightPending) {
                ...
                this.$highlightPending = !0, setTimeout(function () {
                    ...
                    if (t)var i = new u(t.row, t.column, t.row, t.column + 1); else if (e.session.$mode.getMatching)var i = e.session.$mode.getMatching(e.session);
            ...
            var e = this.session;
            if (e.$selectionMarker && e.removeMarker(e.$selectionMarker), e.$selectionMarker = null, this.selection.isEmpty())this.$updateHighlightActiveLine(); else {
            ...
            if (!t.isEmpty() && !t.isMultiLine()) {
                var i = t.start.column - 1, n = t.end.column + 1, o = e.getLine(t.start.row), s = o.length, r = o.substring(Math.max(i, 0), Math.min(n, s));
            ...
            this.clearSelection();
            {
                var c = o.column, h = i.getState(o.row), a = i.getLine(o.row), d = n.checkOutdent(h, a, e);
                i.insert(o, e)
            }
            if (s && s.selection && this.selection.setSelectionRange(2 == s.selection.length ? new u(o.row, c + s.selection[0], o.row, c + s.selection[1]) : new u(o.row + s.selection[0], s.selection[1], o.row + s.selection[2], s.selection[3])), i.getDocument().isNewLine(e)) {
                ...
                i.insert({row: o.row + 1, column: 0}, g)
            }
            ...
            if (this.session.getUseSoftTabs())var c = a - l % a, h = o.stringRepeat(" ", c); else {
                for (var c = l % a; " " == s[t.start.column] && c;)t.start.column--, c--;
            ...
            for (var n = this.session.getLine(e); i.lastIndex < t;) {
                ...
                if (o.index <= t && o.index + o[0].length >= t) {
                    var s = {value: o[0], start: o.index, end: o.index + o[0].length};
                    return s
                }
            }
            return null
            ...
            if (!isNaN(parseFloat(o)) && isFinite(o)) {
                ...
                if (s) {
                    var r = s.value.indexOf(".") >= 0 ? s.start + s.value.indexOf(".") + 1 : s.end, a = s.start + s.value.length - r, l = parseFloat(s.value);
                    l *= Math.pow(10, a), e *= r !== s.end && r > i ? Math.pow(10, s.end - i - 1) : Math.pow(10, s.end - i), l += e, l /= Math.pow(10, a);
                    var c = l.toFixed(a), h = new u(t, s.start, t, s.end);
            ...
            if (i.isEmpty()) {
                ...
                var s = n ? i.start : i.end, r = t.insert(s, t.getTextRange(i), !1);
            ...
            if (!i) {
                if (i = this.find({needle: /[{}()\[\]]/g, preventScroll: !0, start: {row: t.row, column: t.column - 1}}), !i)return;
                var n = i.start;
            ...
            if (e) {
                ...
                var s = this.on("changeSelection", function () {
                    ...
                    if (n && t && i.isFocused()) {
                        var e = i.renderer, s = e.$cursorLayer.$pixelPos, r = e.layerConfig, a = s.top - r.offset;
    ...
    }).call(v.prototype), m.defineOptions(v.prototype, "editor", {selectionStyle: {set: function (e) {
    ...
    var i = e("./range").Range, n = e("./lib/event_emitter").EventEmitter, o = e("./lib/oop"), s = function (e, t, i, n, o, s) {
        var r = this;
                ...
                if (n.start.column >= this.pos.column && n.start.column <= this.pos.column + this.length + 1) {
                    ...
                    if (this.length += o, !this.session.$fromUndo) {
                        if ("insertText" === t.action)for (var r = this.others.length - 1; r >= 0; r--) {
                            var a = this.others[r], l = {row: a.row, column: a.column + s};
    ...
    var r = e("./range_list").RangeList, a = e("./range").Range, l = e("./selection").Selection, c = e("./mouse/multi_select_handler").onMouseDown, h = e("./lib/event"), d = e("./lib/lang"), u = e("./commands/multi_select_commands");
    t.commands = u.defaultCommands.concat(u.multiSelectCommands);
    var g = e("./search").Search, f = new g, p = e("./edit_session").EditSession;
    (function () {
        ...
        this.ranges = null, this.rangeList = null, this.addRange = function (e, t) {
            ...
            if (this.rangeCount > 1) {
                ...
                var i = this.getRange(), n = this.isBackwards(), o = i.start.row, s = i.end.row;
                if (o == s) {
                    if (n)var r = i.end, l = i.start; else var r = i.start, l = i.end;
            ...
            if (this.rangeCount > 1) {
                ...
                var n = this.session.documentToScreenPosition(this.selectionLead), o = this.session.documentToScreenPosition(this.selectionAnchor), s = this.rectangularRangeBlock(n, o);
                s.forEach(this.addRange, this)
            }
        }, this.rectangularRangeBlock = function (e, t, i) {
            var o = [], s = e.column < t.column;
            if (s)var r = e.column, l = t.column; else var r = t.column, l = e.column;
            var c = e.row < t.row;
    ...
    (function () {
        this.updateSelectionMarkers = function () {
            ...
            if (!this.inVirtualSelectionMode) {
                var n, o = i && i.keepOrder, s = 1 == i || i && i.$byLines, r = this.session, a = this.selection, c = a.rangeList, h = (o ? a : c).ranges;
            ...
            if (i.isEmpty())var r = s; else var l = this.session.documentToScreenPosition(n ? i.end : i.start), r = this.session.screenToDocumentPosition(l.row + e, l.column);
            if (n) {
    ...
    }, t.MultiSelect = o, e("./config").defineOptions(m.prototype, "editor", {enableMultiselect: {set: function (e) {
    ...
    function n(e) {
        var t = e.domEvent, n = t.altKey, s = t.shiftKey, r = e.getAccelKey(), a = e.getButton();
        ...
        var l = e.editor, c = l.selection, h = l.inMultiSelectMode, d = e.getDocumentPosition(), u = c.getCursor(), g = e.inSelection() || c.isEmpty() && i(d, u), f = e.x, p = e.y, m = function (e) {
            f = e.clientX, p = e.clientY
        }, v = function () {
            var e = l.renderer.pixelToScreenCoordinates(f, p), t = A.screenToDocumentPosition(e.row, e.column);
        ...
        }, A = l.session, C = l.renderer.pixelToScreenCoordinates(f, p), w = C;
        if (!r || n || s || 0 !== a) {
            if (n && 0 === a) {
    ...
    function i(e, t, i) {
        ...
        if (!o.isMac && r) {
            ...
            if (18 === i || 17 === i) {
                ...
                if (17 === i && 1 === c)a = t.timeStamp; else if (18 === i && 3 === l && 2 === c) {
                    var h = -a;
    ...
    t.addListener = function (e, t, i) {
        ...
        t.addListener(e, "mousedown", function (e) {
            ...
            if (n[s]("mousedown", e), c > 4)c = 0; else if (c > 1)return n[s](h[c], e)
    ...
    var s = !o.isMac || !o.isOpera || "KeyboardEvent"in window ? function (e) {
    ...
    (function () {
        this.foldingStartMarker = null, this.foldingStopMarker = null, this.getFoldWidget = function (e, t, i) {
            ...
            var o = /\S/, s = e.getLine(t), r = s.search(o);
            if (-1 != r) {
            ...
            var r = {row: n, column: o + 1}, a = e.$findClosingBracket(t, r, s);
            if (a) {
            ...
            var s = {row: n, column: o}, r = e.$findOpeningBracket(t, s);
    ...
    var n, o, s, r, a, l = Function.prototype.call, c = Array.prototype, h = Object.prototype, d = c.slice, u = l.bind(h.toString), g = l.bind(h.hasOwnProperty);
    if ((a = g(h, "__defineGetter__")) && (n = l.bind(h.__defineGetter__), o = l.bind(h.__defineSetter__), s = l.bind(h.__lookupGetter__), r = l.bind(h.__lookupSetter__)), 2 != [1, 2].splice(0).length)if (function () {
        ...
        var n = this.slice(e, e + t), o = d.call(arguments, 2), s = o.length;
        if (e === i)s && this.push.apply(this, o); else {
            var r = Math.min(t, i - e), a = e + r, l = a + s - r, c = i - a, h = i - r;
            if (a > l)for (var u = 0; c > u; ++u)this[l + u] = this[a + u]; else if (l > a)for (u = c; u--;)this[l + u] = this[a + u];
            if (s && e === h)this.length = h, this.push.apply(this, o); else for (this.length = h + s, u = 0; s > u; ++u)this[e + u] = o[u]
        }
        return n
    };
    ...
    if (Array.prototype.forEach || (Array.prototype.forEach = function (e) {
        var t = R(this), i = m && "[object String]" == u(this) ? this.split("") : t, n = arguments[1], o = -1, s = i.length >>> 0;
        if ("[object Function]" != u(e))throw new TypeError;
        for (; ++o < s;)o in i && e.call(n, i[o], o, t)
    }), Array.prototype.map || (Array.prototype.map = function (e) {
        var t = R(this), i = m && "[object String]" == u(this) ? this.split("") : t, n = i.length >>> 0, o = Array(n), s = arguments[1];
        if ("[object Function]" != u(e))throw new TypeError(e + " is not a function");
        for (var r = 0; n > r; r++)r in i && (o[r] = e.call(s, i[r], r, t));
        return o
    }), Array.prototype.filter || (Array.prototype.filter = function (e) {
        var t, i = R(this), n = m && "[object String]" == u(this) ? this.split("") : i, o = n.length >>> 0, s = [], r = arguments[1];
        if ("[object Function]" != u(e))throw new TypeError(e + " is not a function");
        for (var a = 0; o > a; a++)a in n && (t = n[a], e.call(r, t, a, i) && s.push(t));
        return s
    }), Array.prototype.every || (Array.prototype.every = function (e) {
        var t = R(this), i = m && "[object String]" == u(this) ? this.split("") : t, n = i.length >>> 0, o = arguments[1];
        if ("[object Function]" != u(e))throw new TypeError(e + " is not a function");
        ...
        var t = R(this), i = m && "[object String]" == u(this) ? this.split("") : t, n = i.length >>> 0;
        if ("[object Function]" != u(e))throw new TypeError(e + " is not a function");
        ...
        do s in this && (o = e.call(void 0, o, i[s], s, t)); while (s--);
        return o
    }), Array.prototype.indexOf && -1 == [0, 1].indexOf(1, 2) || (Array.prototype.indexOf = function (e) {
        var t = m && "[object String]" == u(this) ? this.split("") : R(this), n = t.length >>> 0;
        if (!n)return-1;
        var o = 0;
    ...
    if (!Object.defineProperty || E) {
        var F = "Property description must be an object: ", b = "Object.defineProperty called on non-object: ", y = "getters & setters can not be defined on this javascript engine";
    ...
    if (Object.preventExtensions || (Object.preventExtensions = function (e) {
        ...
        var S = !0, B = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], D = B.length;
    ...
    function n(e, t, n) {
        ...
        if (o.length) {
            var s = i(o, {row: t, column: -1}, r.comparePoints);
            0 > s && (s = -s - 1), s >= o.length - 1 ? s = n > 0 ? 0 : o.length - 1 : 0 === s && 0 > n && (s = o.length - 1);
            var a = o[s];
            if (a && n) {
                if (a.row === t) {
                    do a = o[s += n]; while (a && a.row === t);
                    if (!a)return o.slice()
                }
                var l = [];
                t = a.row;
                do l[0 > n ? "unshift" : "push"](a), a = o[s += n]; while (a && a.row == t);
                return l.length && l
            }
        }
    }

    var o = e("ace/line_widgets").LineWidgets, s = e("ace/lib/dom"), r = e("ace/range").Range;
    t.showErrorMarker = function (e, t) {
        var i = e.session;
        i.widgetManager || (i.widgetManager = new o(i), i.widgetManager.attach(e));
        var r = e.getCursorPosition(), a = r.row, l = i.lineWidgets && i.lineWidgets[a];
        l ? l.destroy() : a -= t;
        var c, h = n(i, a, t);
        if (h) {
            var d = h[0];
        ...
        var u = {row: r.row, fixedWidth: !0, coverGutter: !0, el: s.createElement("div")}, g = u.el.appendChild(s.createElement("div")), f = u.el.appendChild(s.createElement("div"));
        ...
        }, e.keyBinding.addKeyboardHandler(m), e.on("changeSelection", u.destroy), e.on("changeSession", u.destroy), e.on("mouseup", u.destroy), e.on("change", u.destroy), e.session.widgetManager.addLineWidget(u), u.el.onmousedown = e.focus.bind(e), e.renderer.scrollCursorIntoView(null, .5, {bottom: u.el.offsetHeight})
    ...
    (function () {
        this.getRowLength = function (e) {
            ...
            if (t) {
                var i = e.data, n = i.range, o = n.start.row, s = n.end.row - o;
    ...
    var i = e("./lib/oop"), n = e("./lib/event_emitter").EventEmitter, o = e("./range").Range, s = e("./anchor").Anchor, r = function (e) {
    ...
    (function () {
        i.implement(this, n), this.setValue = function (e) {
            ...
            if (t != i) {
                var n = new o(e, t, e, i), s = this.getLine(e), r = s.substring(t, i), a = s.substring(0, t) + s.substring(i, s.length);
            ...
            var i = new o(e, 0, t + 1, 0), n = this.$lines.splice(e, t - e + 1), s = {action: "removeLines", range: i, nl: this.getNewLineCharacter(), lines: n};
            return this._signal("change", {data: s}), n
            ...
            for (var i = this.$lines || this.getAllLines(), n = this.getNewLineCharacter().length, o = t || 0, s = i.length; s > o; o++)if (e -= i[o].length + n, 0 > e)return{row: o, column: e + i[o].length + n};
            return{row: s - 1, column: i[s - 1].length}
    ...
    (function () {
        this.setEditor = function (e) {
            ...
            o.addListener(e, "mousedown", function (e) {
                ...
                var s = a.keyCodeToString(n), r = t.$searchBarKb.findKeyCommand(i, s);
        ...
        ]), this.$searchBarKb = new r, this.$searchBarKb.bindKeys({"Ctrl-f|Command-f|Ctrl-H|Command-Option-F": function (e) {
            ...
            var n = this.editor.find(this.searchInput.value, {skipCurrent: e, backwards: t, wrap: !0, regExp: this.regExpOption.checked, caseSensitive: this.caseSensitiveOption.checked, wholeWord: this.wholeWordOption.checked}), o = !n && this.searchInput.value;
            i.setCssClass(this.searchBox, "ace_nomatch", o), this.editor._emit("findSearchBox", {match: !o}), this.highlight()
    ...
    var i = e("../lib/oop"), n = e("./text").Mode, o = e("./json_highlight_rules").JsonHighlightRules, s = e("./matching_brace_outdent").MatchingBraceOutdent, r = e("./behaviour/cstyle").CstyleBehaviour, a = e("./folding/cstyle").FoldMode, l = e("../worker/worker_client").WorkerClient, c = function () {
    ...
    (function () {
        this.checkOutdent = function (e, t) {
            ...
            if (!o)return 0;
            var s = o[1].length, r = e.findMatchingBracket({row: t, column: s});
    ...
    var i, n = e("../../lib/oop"), o = e("../behaviour").Behaviour, s = e("../../token_iterator").TokenIterator, r = e("../../lib/lang"), a = ["text", "paren.rparen", "punctuation.operator"], l = ["text", "paren.rparen", "punctuation.operator", "comment"], c = {}, h = function (e) {
        var t = -1;
        return e.multiSelect && (t = e.selection.id, c.rangeCount != e.multiSelect.rangeCount && (c = {rangeCount: e.multiSelect.rangeCount})), c[t] ? i = c[t] : void(i = c[t] = {autoInsertedBrackets: 0, autoInsertedRow: -1, autoInsertedLineEnd: "", maybeInsertedBrackets: 0, maybeInsertedRow: -1, maybeInsertedLineStart: "", maybeInsertedLineEnd: ""})
    }, d = function () {
        this.add("braces", "insertion", function (e, t, n, o, s) {
            var a = n.getCursorPosition(), l = o.doc.getLine(a.row);
            if ("{" == s) {
                h(n);
                var c = n.getSelectionRange(), u = o.doc.getTextRange(c);
                if ("" !== u && "{" !== u && n.getWrapBehavioursEnabled())return{text: "{" + u + "}", selection: !1};
                if (d.isSaneInsertion(n, o))return/[\]\}\)]/.test(l[a.column]) || n.inMultiSelectMode ? (d.recordAutoInsert(n, o, "}"), {text: "{}", selection: [1, 1]}) : (d.recordMaybeInsert(n, o, "{"), {text: "{", selection: [1, 1]})
            } else if ("}" == s) {
                h(n);
                var g = l.substring(a.column, a.column + 1);
                if ("}" == g) {
                    var f = o.$findOpeningBracket("}", {column: a.column + 1, row: a.row});
                    if (null !== f && d.isAutoInsertedClosing(a, l, s))return d.popAutoInsertedClosing(), {text: "", selection: [1, 1]}
                }
            } else {
                if ("\n" == s || "\r\n" == s) {
                    h(n);
                    ...
                    var g = l.substring(a.column, a.column + 1);
                    if ("}" === g) {
                        var m = o.findMatchingBracket({row: a.row, column: a.column + 1}, "}");
                        if (!m)return null;
            ...
            if (!s.isMultiLine() && "{" == r) {
                h(n);
                var a = o.doc.getLine(s.start.row), l = a.substring(s.end.column, s.end.column + 1);
            ...
            if ("(" == o) {
                h(i);
                var s = i.getSelectionRange(), r = n.doc.getTextRange(s);
                if ("" !== r && i.getWrapBehavioursEnabled())return{text: "(" + r + ")", selection: !1};
                ...
                if (")" == c) {
                    var u = n.$findOpeningBracket(")", {column: a.column + 1, row: a.row});
                    if (null !== u && d.isAutoInsertedClosing(a, l, o))return d.popAutoInsertedClosing(), {text: "", selection: [1, 1]}
                }
            }
            ...
            if (!o.isMultiLine() && "(" == s) {
                h(i);
                var r = n.doc.getLine(o.start.row), a = r.substring(o.start.column + 1, o.start.column + 2);
            ...
            if ('"' == o || "'" == o) {
                h(i);
                var s = o, r = i.getSelectionRange(), a = n.doc.getTextRange(r);
                if ("" !== a && "'" !== a && '"' != a && i.getWrapBehavioursEnabled())return{text: s + a + s, selection: !1};
                var l = i.getCursorPosition(), c = n.doc.getLine(l.row), u = c.substring(l.column - 1, l.column);
                if ("\\" == u)return null;
    ...
    d.isSaneInsertion = function (e, t) {
        ...
        var o = e.getCursorPosition(), s = t.doc.getLine(o.row);
    ...
    var i = e("../../lib/oop"), n = e("../../range").Range, o = e("./fold_mode").FoldMode, s = t.FoldMode = function (e) {
    ...
    i.inherits(s, o), function () {
        this.foldingStartMarker = /(\{|\[)[^\}\]]*$|^\s*(\/\*)/, this.foldingStopMarker = /^[^\[\{]*(\}|\])|^[\s\*]*(\*\/)/, this.getFoldWidgetRange = function (e, t, i, n) {
            var o = e.getLine(i), s = o.match(this.foldingStartMarker);
            if (s) {
                var r = s.index;
            ...
            var i = e.getLine(t), o = i.search(/\S/), s = t, r = i.length;
            t += 1;
            for (var a = t, l = e.getLength(); ++t < l;) {
                ...
                if (-1 !== c) {
                    ...
                    if (h) {
                        ...
                        if (h.isMultiLine())t = h.end.row; else if (o == c)break
                    }
                    a = t
                }
            }
...
var jsonlint = function () {
    var e = {trace: function () {
    }, yy: {}, symbols_: {error: 2, JSONString: 3, STRING: 4, JSONNumber: 5, NUMBER: 6, JSONNullLiteral: 7, NULL: 8, JSONBooleanLiteral: 9, TRUE: 10, FALSE: 11, JSONText: 12, JSONValue: 13, EOF: 14, JSONObject: 15, JSONArray: 16, "{": 17, "}": 18, JSONMemberList: 19, JSONMember: 20, ":": 21, ",": 22, "[": 23, "]": 24, JSONElementList: 25, $accept: 0, $end: 1}, terminals_: {2: "error", 4: "STRING", 6: "NUMBER", 8: "NULL", 10: "TRUE", 11: "FALSE", 14: "EOF", 17: "{", 18: "}", 21: ":", 22: ",", 23: "[", 24: "]"}, productions_: [0, [3, 1], [5, 1], [7, 1], [9, 1], [9, 1], [12, 2], [13, 1], [13, 1], [13, 1], [13, 1], [13, 1], [13, 1], [15, 2], [15, 3], [20, 3], [19, 1], [19, 3], [16, 2], [16, 3], [25, 1], [25, 3]], performAction: function (e, t, i, n, o, s) {
        var r = s.length - 1;
        switch (o) {
            case 1:
        ...
        {18: [2, 15], 22: [2, 15]},
        {22: [2, 21], 24: [2, 21]}
    ], defaultActions: {16: [2, 6]}, parseError: function (e) {
        throw new Error(e)
    }, parse: function (e) {
        function t(e) {
        ...
        var n = this, o = [0], s = [null], r = [], a = this.table, l = "", c = 0, h = 0, d = 0, u = 2, g = 1;
        ...
        for (var p, m, v, A, C, w, E, F, b, y = {}; ;) {
            if (v = o[o.length - 1], this.defaultActions[v] ? A = this.defaultActions[v] : (null == p && (p = i()), A = a[v] && a[v][p]), "undefined" == typeof A || !A.length || !A[0]) {
                if (!d) {
                    ...
                    var x = "";
                    x = this.lexer.showPosition ? "Parse error on line " + (c + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + b.join(", ") + ", got '" + this.terminals_[p] + "'" : "Parse error on line " + (c + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'"), this.parseError(x, {text: this.lexer.match, token: this.terminals_[p] || p, line: this.lexer.yylineno, loc: f, expected: b})
                }
                if (3 == d) {
            ...
            switch (A[0]) {
                case 1:
                    ...
                    break;
                case 2:
                    if (E = this.productions_[A[1]][1], y.$ = s[s.length - E], y._$ = {first_line: r[r.length - (E || 1)].first_line, last_line: r[r.length - 1].last_line, first_column: r[r.length - (E || 1)].first_column, last_column: r[r.length - 1].last_column}, C = this.performAction.call(y, l, h, c, this.yy, A[1], s, r), "undefined" != typeof C)return C;
...
"undefined" != typeof require && "undefined" != typeof exports && (exports.parser = jsonlint, exports.parse = function () {
    ...
    if ("undefined" != typeof process)var t = require("fs").readFileSync(require("path").join(process.cwd(), e[1]), "utf8"); else var i = require("file").path(require("file").cwd()), t = i.join(e[1]).read({charset: "utf-8"});
...
Notify.prototype.showNotification = function (e, t) {
    ...
    var s = e.type || "notification", r = e.closeButton !== !1, a = document.createElement("div");
    ...
    if (s)util.prompt({title: "Open file", titleSubmit: "Open", description: "Select a file on your computer.", inputType: "file", inputName: "file", callback: function (e, t) {
        if (e) {
            if (s) {
        ...
        var r = "fileretriever-upload-" + Math.round(1e15 * Math.random()), a = document.createElement("iframe");
        ...
        }, document.body.appendChild(a), util.prompt({title: "Open file", titleSubmit: "Open", description: "Select a file on your computer.", inputType: "file", inputName: "file", formAction: this.scriptUrl, formMethod: "POST", formTarget: r, callback: function (e) {
            e && n()
        }})
    }
    ...
    if (e) {
        ...
        this.saving = !0;
        var o, s = this, r = t.name || null, a = i && i.silent || !1;
        ...
        ajax.put(this.url, l, c, function (e, i, a) {
            if (s.notify.removeMessage(o), 200 == a) {
                ...
                s.revs[c] = h, n(null, {name: r || null, _id: c, _rev: h})
...
var treeEditor = null, codeEditor = null, app = {}, AUTO_SAVE_DELAY = 4e3, LOCAL_SAVE_DELAY = 1e3;
app.doc = {name: null, _id: null, _rev: null}, app.lastChanged = void 0, app.changed = !1, app.autoSaveTimer = null, app.localSaveTimer = null, app.conflictMessages = [], app.CodeToTree = function () {
    ...
    try {
        app.notify = new Notify, app.retriever = new FileRetriever({scriptUrl: "fileretriever.php", notify: app.notify}), app.store = new OnlineStore({url: "http://api.jsoneditoronline.org/docs/", notify: app.notify});
        ...
        var c, h = new QueryParams, d = h.getValue("json"), u = h.getValue("url"), g = h.getValue("id"), f = "#new" == location.hash, p = "#open" == location.hash;
        if (g)app.openOnline(g); else if (d)codeEditor.setText(d), treeEditor.setText(d), app.changed = !1; else if (u)app.openUrl(u); else if (f)location.hash = "", codeEditor.setText(""), app.changed = !1; else if (p)location.hash = "", app.openFromDisk(); else if (void 0 !== (c = localStorage.data))codeEditor.setText(c), treeEditor.setText(c), app.changed = !1; else {
    ...
    app.store.remove(e, function (t) {
        if (t)app.notify.showError(t); else {
            var i = localStorage.files, n = i ? JSON.parse(i) : {};
    ...
    if (c && (l -= c + a), app.splitter) {
        ...
        } else f = l * h - p, s.innerHTML = "&lsaquo;", s.title = "Drag left to show the tree editor"; else f = 0, s.innerHTML = "&rsaquo;", s.title = "Drag right to show the code editor";
