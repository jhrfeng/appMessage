...
<%
	...
	if(type!=null){
		if(type.equals("001")){
			...
			urlString=SuperServiceTest.getUrlString("/accountsys/logout", DataSource.otherAccountLogin());
		}else if(type.equals("003")){
			urlString=SuperServiceTest.getUrlString("/information/showInfo", DataSource.infomationRequestId());
		}else if(type.equals("004")){
			urlString=SuperServiceTest.getUrlString("/information/updateInfo", DataSource.infomationPO());
			...
			urlString=SuperServiceTest.getUrlString("/information/loadFriendList", DataSource.infomationRequestId());
			...
			urlString=SuperServiceTest.getUrlString("/information/addFriend", DataSource.friendListPO());
		}else if(type.equals("009")){
			urlString=SuperServiceTest.getUrlString("/information/delFriend", DataSource.friendListPO());
		}else if(type.equals("010")){
			urlString=SuperServiceTest.getUrlString("/information/up_honeyname", DataSource.upHoneyname());
			...
			urlString=SuperServiceTest.getUrlString("/information/up_birthday", DataSource.upBirhday());
		}else if(type.equals("013")){
			urlString=SuperServiceTest.getUrlString("/information/up_area", DataSource.upArea());
		}else if(type.equals("014")){
			urlString=SuperServiceTest.getUrlString("/information/up_school", DataSource.upSchool());
		}else if(type.equals("015")){
			urlString=SuperServiceTest.getUrlString("/information/up_class", DataSource.upClass());
			...
			urlString=SuperServiceTest.getUrlString("/information/update_signature", DataSource.companyInfo());
		}
	}
